          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                SizedBox(
                  height: 300,  // Adjusted height -  more appropriate for a pie chart
                  child: PieChart(
                    PieChartData(
                      sections: _getSections(categoryExpenses),
                      centerSpaceRadius: 0,  // Make it a full pie chart, not a donut
                      sectionsSpace: 4,     // Slightly reduced spacing
    ...
    showCupertinoDialog(
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          title: Text(category),
          content: Text(
              'Tổng chi tiêu: ${NumberFormat("#,##0", "vi_VN").format(amount)} VNĐ'), // Format
          actions: <Widget>[
